...
import { getCurrentMentee, getMenteeAssignments, getUpcomingMentoringSessions } from "@/lib/mock-data"
...
export function MenteeOverview() {
  ...
  const upcomingSessions = getUpcomingMentoringSessions(menteeData.id, 'mentee')
