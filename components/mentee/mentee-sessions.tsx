...
const pastSessions = [
  {
    ...
    notes:
      "Covered binary search implementation, discussed edge cases and optimization techniques. Made good progress understanding the algorithm.",
  ...
  },
  {
    ...
    notes:
      "Learned about DFS and BFS concepts. Need more practice with graph representation and traversal patterns.",
                    ...
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div className="flex">
                        {Array.from({ length: 5 }, (_, i) => (
                          <span
                            key={i}
                            className={`text-sm ${i < session.rating ? "text-yellow-500" : "text-gray-300"}`}
                          >
                            ★
                          </span>
                        ))}
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage your mentoring sessions and track progress</p>
        </div>
        <div className="flex gap-2">
            ...
            <DialogContent className="max-w-2xl">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Textarea id="topic" placeholder="Describe what you'd like to work on in this session..." rows={3} />
                </div>
                <div>
                  <Label htmlFor="questions">Questions or specific areas</Label>
                  <Textarea id="questions" placeholder="Any specific questions or areas you'd like help with?" rows={2} />
                </div>
