...
import { Search, User, Home, FileText, Calendar, BookOpen, Settings, LogOut, Trophy, Menu, Map } from "lucide-react"
...
interface MenteeNavigationProps {
  activeTab: string
...
export function MenteeNavigation({ activeTab, onTabChange }: MenteeNavigationProps) {
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden md:flex items-center gap-2 px-3 py-1 bg-primary/10 rounded-full border border-primary/20">
              ...
              <span className="font-bold text-sm">{mentee.totalXP} XP</span>
              ...
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="gap-3 p-2 hover:bg-muted/80 transition-colors rounded-lg">
                  ...
                  <div className="hidden md:flex flex-col items-start">
                    <span className="text-sm font-medium text-foreground">{mentee.name.split(' ')[0]}</span>
                    <span className="text-xs text-muted-foreground">Level {mentee.currentLevel}</span>
                  </div>
                </Button>
              </DropdownMenuTrigger>
                ...
                <div className="p-3 border-b">
                  ...
                  <div className="mt-2">
                    <div className="flex items-center justify-between text-xs">
                      <span>Level {mentee.currentLevel}</span>
                      <span>{mentee.totalXP} XP</span>
                    </div>
                    <Progress 
